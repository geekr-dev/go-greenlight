...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst any) error {
	...
	// Require that the request body is an object and not an array.
	...
	if err != nil {
		...
		case strings.HasPrefix(err.Error(), "json: unknown field "):
			fieldBName := strings.TrimPrefix(err.Error(), "json: unknown field ")
			return errors.New("body contains unknown key " + fieldBName)
